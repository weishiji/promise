var Promise = (function(){
    ...
    var privateFun = (function(){
      ...
      return {
        ...
        ,taskCallback : function(param){
          ...
          //判断出现stop函数的时候，结束stop之后的所有任务
          __this.stopIndex === __this.count ? __this.tasksArr = [] : '';
        ...
        ,thenCallback : function(){
          ...
          if(_private.isFun(thenFun)){
            thenFun.call(this,data)  
          }
        }
        ,nextAction : function(){
    ...
    P.prototype.stop = function(){
      //终止并销毁stop函数之后的所有任务
      this.stopIndex = this.tasksArr.length;
      return this;
    }
